...
<input name="nom" id="TextArea1" type="text" style="position:absolute ;top:50px;width:100%;height:26px;z-index:16;" rows="0" cols="50" placeholder="Nom de produit"/>
<input name="version" id="TextArea2" style="position:absolute ;top:113px;width:100%;height:26px;z-index:13;" rows="0" cols="50"placeholder="Version de produit"/>
<input name="Prix" id="TextArea3" style="position:absolute;top:170px;width:100%;height:26px;z-index:14;" rows="0" cols="50"placeholder="Prix de produit"/>
<input name="Descreption" id="TextArea4" style="position:absolute ;top:227px;width:100%;height:50px;z-index:15;" rows="0" cols="50"placeholder="Descreption de produit"/>
