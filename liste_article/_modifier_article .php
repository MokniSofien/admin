...
<span style="color:#05C1E9;font-family:'Times New Roman';font-size:19px;">Modifier Article</span></div>
...
<input name="titre" id="TextArea2" style="position:absolute;left:143px;top:113px;width:313px;height:26px;z-index:8;" rows="0" cols="50" placeholder="titre de votre article"  value="<?php echo $ligne['titre'];?>"/>
<input name="text" id="TextArea3" style="position:absolute;left:143px;top:170px;width:313px;height:26px;z-index:9;" rows="0" cols="50"placeholder="écrire votre article " value="<?php echo $ligne['text'];?>"/>
<input name="auteur" id="TextArea5" style="position:absolute;left:143px;top:240px;width:313px;height:26px;z-index:11;" rows="0" cols="50"placeholder="auteur" value="<?php echo $ligne['auteur'];?>"/>
