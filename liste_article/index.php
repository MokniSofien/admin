...
<td class="cell2"><span style="color:#000000;font-family:Arial;font-size:13px;line-height:16px;"><a href="../ajoute_article/index.php?id=<?php echo $_GET['id'];?>"><img src="../images/pain.png" id="Imagee" alt=""></a> </span></td>
<td class="cell2"><span style="color:#000000;font-family:Arial;font-size:13px;line-height:16px;"> </span><a href="_modifier_article.php?id=<?php echo $ligne['id'];?>&idd=<?php echo $_GET['id'];?>"><img src="../images/%2B.png" id="Imagee" alt=""></a></td>
<td class="cell3"><span style="color:#000000;font-family:Arial;font-size:13px;line-height:16px;"> </span><a href="suppression_article.php?id=<?php echo $ligne['id'] ;?>&idd=<?php echo $_GET['id'];?>"><img src="../images/poubel.png" id="Imagee" alt=""></a></td>
</tr>
<?php }
